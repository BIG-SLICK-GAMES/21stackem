...
- `types.ts`: shared data shapes used by the BSG platform API contract
...
The game talks to the BSG platform backend for account, profile, wallet, shop, rewards, transactions, analytics, and optional game adapters.
