...
Copy `.env.example` to `.env` and point the frontend at the BSG platform API you are actually running.

For local platform development, start the BSG API from `D:\BSG PLATFORM\apps\entry`:
...
- `EXPO_PUBLIC_SOCKET_BASE_URL=ws://127.0.0.1:3001`
